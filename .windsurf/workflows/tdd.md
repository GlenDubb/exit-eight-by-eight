---
description: Test-driven development with red-green-refactor loop. Use when building features or fixing bugs using TDD, or for test-first development.
---
...
See `.windsurf/references/tdd-tests.md` for examples and `.windsurf/references/tdd-mocking.md` for mocking guidelines.
...
- [ ] Identify opportunities for deep modules (see `.windsurf/references/tdd-deep-modules.md`)
- [ ] Design interfaces for testability (see `.windsurf/references/tdd-interface-design.md`)
...
After all tests pass, look for refactor candidates (see `.windsurf/references/tdd-refactoring.md`):
